...
export const hospitality: Hospitality[] = [
  ...
  {
    id: "ostello-tratturo",
    name: "Ostello del Tratturo",
    type: "sleep",
    subtype: "Hostel",
    address: "Via Municipio 31, Navelli (AQ)",
    description: {
      it: "Un accogliente ostello low-cost nel centro medievale di Navelli, ideale per backpacker e gruppi. Si trova lungo l'antico tratturo Centurelle-Montesecco.",
      en: "A welcoming budget hostel in the medieval center of Navelli, ideal for backpackers and groups. Located along the ancient Centurelle-Montesecco drover's road.",
      fr: "Un auberge économique accueillante dans le centre médiéval de Navelli, idéal pour les routards et les groupes.",
      de: "Eine einladende günstige Herberge im mittelalterlichen Zentrum von Navelli, ideal für Backpacker und Gruppen.",
      es: "Un acogedor albergue económico en el centro medieval de Navelli, ideal para mochileros y grupos.",
    },
    tags: ["hostel", "budget", "groups", "centro storico"],
    coordinates: { lat: 42.2386, lng: 13.7296 },
    priceRange: "$",
  },
  {
    id: "sotto-volte",
  ...
  {
    id: "casa-verde-sarra",
    name: "Casa Verde / Agriturismo Sarra",
    type: "sleep",
    subtype: "Agriturismo",
    address: "Viale Umberto I 9, Civitaretenga (AQ)",
    phone: "+39 0862 959163",
    website: "https://casaverdesarra.it",
    description: {
      it: "Storico casale vicino al Monastero di Sant'Antonio, legato alla famiglia Sarra — fondatori nel 1971 della Cooperativa Altopiano di Navelli e pionieri dello zafferano DOP. Piccolo museo rurale, shop di prodotti locali (zafferano, ceci, lenticchie), ristorante interno e area camper. Perfetto per vivere la raccolta dello zafferano in ottobre–novembre.",
      en: "A historic farmhouse near the Monastery of Sant'Antonio, linked to the Sarra family — founders in 1971 of the Cooperativa Altopiano di Navelli and pioneers of DOP Aquila saffron. Features a small rural history museum, a shop selling local products, an on-site restaurant, and camper parking.",
      fr: "Une ferme historique près du Monastère de Sant'Antonio, liée à la famille Sarra — pionniers du safran DOP. Petit musée rural, boutique, restaurant et aire camping-car.",
      de: "Ein historisches Bauernhaus in der Nähe des Klosters Sant'Antonio, verbunden mit der Familie Sarra — Pioniere des DOP-Safrans. Kleines Landmuseum, Shop, Restaurant und Wohnmobilstellplatz.",
      es: "Una histórica casa de campo cerca del Monasterio de Sant'Antonio, ligada a la familia Sarra — pioneros del azafrán DOP. Pequeño museo rural, tienda, restaurante y zona de autocaravanas.",
    },
    tags: ["agriturismo", "saffron", "rural museum", "camper-friendly", "families"],
    coordinates: { lat: 42.2170, lng: 13.7240 },
    priceRange: "$",
  },
  {
  ...
  {
    id: "casa-verde-restaurant",
    name: "Casa Verde / Agriturismo Sarra (Ristorante)",
    type: "eat",
    subtype: "Agriturismo Restaurant",
    address: "Viale Umberto I 9, Civitaretenga (AQ)",
    phone: "+39 0862 959163",
    description: {
      it: "Il ristorante interno dell'Agriturismo Sarra serve cucina genuina a km 0 con ingredienti propri: zafferano, ceci, lenticchie e specialità di stagione. Vero sapore dell'altopiano di Navelli.",
      en: "The on-site restaurant at Agriturismo Sarra serves genuine farm-to-table cuisine using zero-kilometre ingredients: saffron, chickpeas, lentils and seasonal specialities.",
      fr: "Le restaurant de l'Agriturismo Sarra propose une cuisine ferme-à-table à zéro km : safran, pois chiches, lentilles et spécialités de saison.",
      de: "Das Restaurant im Agriturismo Sarra serviert echte Farm-to-Table-Küche mit Zutaten von Null Kilometern.",
      es: "El restaurante del Agriturismo Sarra sirve auténtica cocina de la granja a la mesa con ingredientes de km 0.",
    },
    tags: ["agriturismo", "farm-to-table", "zero km", "saffron", "lunch"],
    coordinates: { lat: 42.2170, lng: 13.7240 },
    priceRange: "$",
  },
