...
export const translations = T({
  ...
  home_intro: {
    it: "Arroccato a 760 metri sull'altopiano omonimo, Navelli è un labirinto di vicoli, archi e palazzi in pietra. Da qui, nel XIII secolo, il monaco domenicano Fra' Santucci portò dalla Spagna i bulbi di Crocus sativus che hanno reso questa terra famosa nel mondo per lo zafferano DOP — l'oro rosso d'Abruzzo.",
