...
export const stops: Stop[] = [
  ...
  },
  {
    ...
    fullDescription: {
      it: "è uno dei principali e più caratteristici accessi storici al borgo medievale di Navelli, in provincia dell'Aquila. Situata nel settore nord/sud-est del nucleo fortificato, la porta si distingue per il suo suggestivo arco gotico ogivale. La porta appartiene alla cinta muraria originaria del borgo trecentesco. A differenza di altre porte riedificate dopo il forte terremoto del 1456, mantiene la sua identità storica originaria.",
      en: "It is one of the main and most characteristic historical access points to the medieval village of Navelli, in the province of L'Aquila. Located in the north/southeast sector of the fortified core, the gate stands out for its evocative Gothic ogival arch. The gate belongs to the original walls of the 14th-century village. Unlike other gates rebuilt after the strong earthquake of 1456, it retains its original historical identity.",
      fr: "C'est l'un des principaux et des plus caractéristiques points d'accès historiques au village médiéval de Navelli, dans la province de L'Aquila. Située dans le secteur nord/sud-est du noyau fortifié, la porte se distingue par son évocateur arc gothique ogival. La porte appartient aux murs originaux du village du XIVe siècle. Contrairement à d'autres portes reconstruites après le fort tremblement de terre de 1456, elle conserve son identité historique originale.",
      de: "Es ist einer der wichtigsten und charakteristischsten historischen Zugangspunkte zum mittelalterlichen Dorf Navelli, in der Provinz L'Aquila. Das Tor befindet sich im Nord-/Südostsektor des befestigten Kerns und zeichnet sich durch seinen eindrucksvollen gotischen Spitzbogen aus. Das Tor gehört zu den ursprünglichen Mauern des Dorfes aus dem 14. Jahrhundert. Im Gegensatz zu anderen Toren, die nach dem starken Erdbeben von 1456 wieder aufgebaut wurden, behält es seine ursprüngliche historische Identität bei.",
      es: "Es uno de los principales y más característicos puntos de acceso históricos al pueblo medieval de Navelli, en la provincia de L'Aquila. Ubicada en el sector norte/sureste del núcleo fortificado, la puerta se destaca por su evocador arco gótico ojival. La puerta pertenece a las murallas originales del pueblo del siglo XIV. A diferencia de otras puertas reconstruidas después del fuerte terremoto de 1456, conserva su identidad histórica original.",
    },
    category: "gate",
